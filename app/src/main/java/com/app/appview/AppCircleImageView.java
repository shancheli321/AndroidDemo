...
public class AppCircleImageView extends ImageView {
    ...
    public AppCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AppCircleImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.AppCircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.AppCircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.AppCircleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.AppCircleImageView_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
