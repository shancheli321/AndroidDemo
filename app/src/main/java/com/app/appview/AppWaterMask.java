...
import com.app.utils.system.AppScreenUtil;

public class AppWaterMask {
    ...
    private static AppWaterMask sInstance;

    private AppWaterMask() {
        mText = "";
    ...
    public static AppWaterMask getInstance() {
        if (sInstance == null) {
            synchronized (AppWaterMask.class) {
                sInstance = new AppWaterMask();
            }
        }
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public AppWaterMask setText(String text) {
        mText = text;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public AppWaterMask setTextColor(int color) {
        mTextColor = color;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public AppWaterMask setTextSize(float size) {
        mTextSize = size;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public AppWaterMask setRotation(float degrees) {
        mRotation = degrees;
        return sInstance;
    }
    ...
    private class WatermarkDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            mPaint.setTextSize(AppScreenUtil.sp2px(mTextSize)); // ConvertUtils.spToPx()这个方法是将sp转换成px，ConvertUtils这个工具类在我提供的demo里面有
