...
public class AudioFileUtil {
    ...
    public static String getPcmFileAbsolutePath(String fileName) {
        ...
        if (isSdcardExit()) {
            ...
            String fileBasePath = AppSingle.getInstance().getContext().getExternalFilesDir(null).getPath() + AUDIO_PCM_BASEPATH;
    ...
    public static String getWavFileAbsolutePath(String fileName) {
        ...
        if (isSdcardExit()) {
            ...
            String fileBasePath = AppSingle.getInstance().getContext().getExternalFilesDir(null).getPath() + AUDIO_WAV_BASEPATH;
            File file = new File(fileBasePath);
