...
public class AudioRecorder {
     ...
     */
    public void startRecord(final AudioRecordStreamListener listener) {
...
//                mergePCMFilesToWAVFile(filePaths);
     ...
     * @param listener 音频流的监听
     */
    private void writeDataTOFile(AudioRecordStreamListener listener) {
    ...
    private void mergePCMFilesToWAVFile(final List<String> filePaths) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                if (AudioPcmToWav.mergePCMFilesToWAVFile(filePaths, AudioFileUtil.getWavFileAbsolutePath(fileName))) {
                    //操作成功
                } else {
                    //操作失败
